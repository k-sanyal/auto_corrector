...
* Скрипта, основанного на биграммах, для лучшего распознавания ошибок в контексте, более масштабного корпуса текстов, базы данных, в которой хранится корпус, для более быстрого выполнения программы, более продвинутого алгоритма, позволяющего исправлять слова, отличающиеся от правильных более чем на 1 символ
